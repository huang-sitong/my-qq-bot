...
ALLOWED_RUNTIME_DEPENDENCIES: dict[str, set[str]] = {
    ...
    "commands": {"common", "context", "domain"},
    "common": set(),
    "context": {"common", "conversation", "domain"},
    "conversation": {"domain"},
    "domain": set(),
    "execution": {"common", "context", "conversation", "domain", "knowledge", "skill"},
    "knowledge": {"common", "domain"},
    "memory": set(),
    "orchestration": {
        "common",
        "context",
    ...
    "protocol": {"common", "domain"},
    "skill": set(),
    "vision": {"common", "domain"},
}
